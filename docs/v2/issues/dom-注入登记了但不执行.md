...
**状态**:**已解决**(2026-08-20),但**没修干净** ——
见 [dom-binding-不活过导航.md](dom-binding-不活过导航.md):
下面那条"binding 不一定活过导航"当时只量了一半,真相是**每次都不活**,
而且还有一个从没人调过的 `Runtime.enable` 盖在上面。
...
**② binding 不一定活过导航。**(**这句话是错的** ——
后来量清楚了:它每次都不活。见
[dom-binding-不活过导航.md](dom-binding-不活过导航.md))
